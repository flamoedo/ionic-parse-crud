...
var HomePage = /** @class */ (function () {
    function HomePage(router, alertController) {
        this.router = router;
    ...
    HomePage.prototype.initial_query = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.query.find().then(function (results) {
                            _this.scores = [];
                            for (var i = 0; i < results.length; i++) {
                                var object = results[i];
                                _this.scores.push(object);
                            }
                        })];
                    case 1:
                        _a.sent();
    ...
    HomePage.prototype.delete = function (score) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    text: 'Okay',
                                    handler: function () {
                                        _this.query.get(score.id)
                                            .then(function (myObject) {
                                            myObject.destroy();
                                            var i = _this.scores.indexOf(score);
    ...
    HomePage.prototype.edit = function (key, list) {
        console.log(list);
        list.closeOpened();
    ...
    HomePage = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["AlertController"]])
    ], HomePage);
    return HomePage;
}());
