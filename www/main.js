...
var AppComponent = /** @class */ (function () {
    function AppComponent(route, router, platform, splashScreen, statusBar, auth) {
        this.route = route;
        this.router = router;
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            if (_this.auth.getAuthenticationState() != 'true') {
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_8__["IonicStorageModule"].forRoot(), _angular_service_worker__WEBPACK_IMPORTED_MODULE_9__["ServiceWorkerModule"].register('ngsw-worker.js', { enabled: _environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].production })
            ],
            providers: [
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.setAuthenticationState = function (state) {
        this.storage.set("LOGGED", state);
    };
    AuthenticationService.prototype.getAuthenticationState = function () {
...
module.exports = __webpack_require__(/*! C:\Users\flfilho\ionic-parse-crud\src\main.ts */"./src/main.ts");
